...
1. **Afterthought** – You already captured a meeting in Granola. Later you remember something. We fetch that note, weave your new thought in, and save the blend here. Granola is not modified. The ring gets a short notification. If Pebble accepts `coreSchema`, it can also land as a list item.
2. **Prep me** – “Prep me for Acme” or “prep me for the visual canvas pitch.” We look up matching Granola notes from the last 30 days. If you name a company or person, we use the **most recent** matching meeting, not all ten. Say “this week” or “all meetings with X” for a wider recap. Pitch wording asks Granola to coach from your recorded pitches: what to repeat, what not to say.
...
2. Score title + attendees against the words you spoke.
...
| Surface | Role |
| --- | --- |
| This website | Connect Granola, copy Pebble settings, rehearse without the ring, browse saved afterthoughts |
...
| Name | Required | Notes |
| --- | --- | --- |
| `DATABASE_URL` | yes | Neon Postgres is fine |
| `NEON_CLAIM_URL` | no | Shown in the UI |
